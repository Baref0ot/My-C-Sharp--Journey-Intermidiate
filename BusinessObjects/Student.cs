...
namespace StudentRegistrationSystem {
    public class Student : Person {
        ...
        **/
         ...
         **/
        public bool selectDB(int sid) {
            setID(sid);
            DBSetup();
            cmd = "Select * from Students where ID = " +  getID();
        ...
        public void getSchedule() {
            cmd = "Select CRN from StudentSchedule where StudentID = " + getID();
            OleDbDataAdapter2.SelectCommand.CommandText = cmd;
            OleDbDataAdapter2.SelectCommand.Connection = OleDbConnection2;
            Console.WriteLine(cmd);
            try {
        ...
        public bool insertDB() {
            DBSetup();
            cmd = "INSERT into Students values("+ getID() +", "+ "'"+getFirstName()+"'" +", "+ "'"+getLastName()+"'" +", "+ "'"+address.getStreetName()+"'" +", "+ "'"+address.getCity()+"'" +", "+ "'"+address.getState()+"'" +", "+ address.getZip() +", "+ "'"+getEmail()+"'" +", "+ getGPA() +")";
        ...
        public bool updateDB() {
            cmd = "Update Students set FirstName = '" + getFirstName() + "', " + "LastName = '" + getLastName() + "', " + "Street = '" + address.getStreetName() + "', " +  "City = '" + address.getCity() + "', " + "State = '" + address.getState() + "', " + "Zip = " + address.getZip() + ", " + "Email = '" + getEmail() + "', " + "GPA = " + getGPA() + " where ID = " + getID() + "";
        ...
        public Student(double gpa, int d, string fName, string lName, string eml, Address a1) : base(d, fName, lName, eml, a1) {
            setGPA(gpa);
        }// end empty Construct
